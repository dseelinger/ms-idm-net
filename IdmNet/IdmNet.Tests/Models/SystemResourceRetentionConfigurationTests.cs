...
namespace IdmNet.Models.Tests
{
    public class SystemResourceRetentionConfigurationTests
    {
        ...
        {
            _it.ObjectType.Should().Be("SystemResourceRetentionConfiguration");
        }
        ...
        public void It_has_a_constructor_that_takes_an_IdmResource()
        {
            ...
            it.ObjectType.Should().Be("SystemResourceRetentionConfiguration");
        ...
        public void It_can_get_and_set_RetentionPeriod()
        {
            ...
            // Assert
            _it.RetentionPeriod.Should().Be(123);
        }
