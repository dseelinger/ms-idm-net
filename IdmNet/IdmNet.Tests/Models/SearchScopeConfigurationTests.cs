...
namespace IdmNet.Models.Tests
{
    public class SearchScopeConfigurationTests
    {
        ...
        {
            _it.ObjectType.Should().Be("SearchScopeConfiguration");
        }
        ...
        public void It_has_a_constructor_that_takes_an_IdmResource()
        {
            ...
            it.ObjectType.Should().Be("SearchScopeConfiguration");
        ...
        public void It_can_get_and_set_msidmSearchScopeAdvancedFilter()
        {
            ...
            // Assert
            _it.msidmSearchScopeAdvancedFilter.Should().Be("A string");
        }
        ...
        public void It_can_get_and_set_SearchScopeColumn()
        {
            ...
            // Assert
            _it.SearchScopeColumn.Should().Be("A string");
        }
        ...
        public void It_can_get_and_set_SearchScopeContext()
        {
            ...
            // Assert
            _it.SearchScopeContext[0].Should().Be("foo1");
            _it.SearchScopeContext[1].Should().Be("foo2");
        }
        ...
        public void It_can_get_and_set_NavigationPage()
        {
            ...
            // Assert
            _it.NavigationPage.Should().Be("A string");
        }
        ...
        public void It_can_get_and_set_SearchScopeTargetURL()
        {
            ...
            // Assert
            _it.SearchScopeTargetURL.Should().Be("A string");
        }
        ...
        public void It_can_get_and_set_SearchScopeResultObjectType()
        {
            ...
            // Assert
            _it.SearchScopeResultObjectType.Should().Be("A string");
        }
        ...
        public void It_can_get_and_set_SearchScope()
        {
            ...
            // Assert
            _it.SearchScope.Should().Be("A string");
        }
