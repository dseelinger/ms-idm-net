...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.WorkflowInstance<br />
...
**C++**<br />
``` C++
public ref class WorkflowInstance : public IdmResource
```
...
<a href="#workflowinstance-class">Back to Top</a>
...
(aka Resource ID) The value of the attribute is a globally unique identifier (GUID) assigned by FIM to each resource when it is created. Note that it is not required here since this class also represents resources that may not have been created as well as existing resources.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_WorkflowInstance_ObjectType">ObjectType</a></td><td>
Object Type (can only be WorkflowInstance)
 (Overrides <a href="P_IdmNet_Models_IdmResource_ObjectType">IdmResource.ObjectType</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_WorkflowInstance_Request">Request</a></td><td>
Request - The Request associated with the given Approval.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_WorkflowInstance_Requestor">Requestor</a></td><td>
...
(aka Resource Time) The date and time of a representation of a resource. This attribute is updated by the FIM service. This attribute can be used to define time triggered Management Policy Rules.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_WorkflowInstance_Target">Target</a></td><td>
Target - Reference to the target of a request.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_WorkflowInstance_WorkflowDefinition">WorkflowDefinition</a></td><td>
Workflow Definition -</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_WorkflowInstance_WorkflowStatus">WorkflowStatus</a></td><td>
Workflow Status - Enumeration representing the current status of a workflow instance.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_WorkflowInstance_WorkflowStatusDetail">WorkflowStatusDetail</a></td><td>
Workflow Status Detail - This attribute is used to track workflow instance exceptions to assist with troubleshooting and auditing workflow execution.</td></tr></table>&nbsp;
<a href="#workflowinstance-class">Back to Top</a>
