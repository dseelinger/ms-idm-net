# ObjectVisualizationConfiguration Class
...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.ObjectVisualizationConfiguration<br />
...
**VB**<br />
``` VB
Public Class ObjectVisualizationConfiguration
	Inherits IdmResource
```

**C++**<br />
``` C++
public ref class ObjectVisualizationConfiguration : public IdmResource
```

**F#**<br />
``` F#
type ObjectVisualizationConfiguration =  
    class
        inherit IdmResource
    end
```

The ObjectVisualizationConfiguration type exposes the following members.
...
<a href="#objectvisualizationconfiguration-class">Back to Top</a>
