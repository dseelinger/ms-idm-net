# SearchScopeConfiguration Class
...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.SearchScopeConfiguration<br />
...
**VB**<br />
``` VB
Public Class SearchScopeConfiguration
	Inherits IdmResource
```

**C++**<br />
``` C++
public ref class SearchScopeConfiguration : public IdmResource
```

**F#**<br />
``` F#
type SearchScopeConfiguration =  
    class
        inherit IdmResource
    end
```

The SearchScopeConfiguration type exposes the following members.
...
<a href="#searchscopeconfiguration-class">Back to Top</a>
...
(aka Expiration Time) The date and time when the resource expires. The appropriate Management Policy Rule will delete the resource when the current date and time is later than the date and time specified in this attribute.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SearchScopeConfiguration_IsConfigurationType">IsConfigurationType</a></td><td>
...
The region and language for which the representation of a resource has been adapted.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SearchScopeConfiguration_msidmSearchScopeAdvancedFilter">msidmSearchScopeAdvancedFilter</a></td><td>
Advanced Filter - A fully-formed search string with search term tokens that the search scope will execute.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_IdmResource_MVObjectID">MVObjectID</a></td><td>
(aka MV Resource ID) The GUID of an entry in the FIM metaverse corresponding to this resource.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SearchScopeConfiguration_NavigationPage">NavigationPage</a></td><td>
Navigation Page -</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_IdmResource_ObjectID">ObjectID</a></td><td>
(aka Resource ID) The value of the attribute is a globally unique identifier (GUID) assigned by FIM to each resource when it is created. Note that it is not required here since this class also represents resources that may not have been created as well as existing resources.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SearchScopeConfiguration_ObjectType">ObjectType</a></td><td>
Object Type (can only be SearchScopeConfiguration)
 (Overrides <a href="P_IdmNet_Models_IdmResource_ObjectType">IdmResource.ObjectType</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SearchScopeConfiguration_Order">Order</a></td><td>
Order - Precedence of this item within a parent grouping</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_IdmResource_ResourceTime">ResourceTime</a></td><td>
(aka Resource Time) The date and time of a representation of a resource. This attribute is updated by the FIM service. This attribute can be used to define time triggered Management Policy Rules.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SearchScopeConfiguration_SearchScope">SearchScope</a></td><td>
Search Scope Filter - XPath expression of which resources are to be returned by the search scope.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SearchScopeConfiguration_SearchScopeColumn">SearchScopeColumn</a></td><td>
Attribute - System name (case sensitive) of the type of attribute to be shown in search results.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SearchScopeConfiguration_SearchScopeContext">SearchScopeContext</a></td><td>
Attribute Searched - System name (case sensitive) of the attributes that will be used to match against the search string supplied by the user.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SearchScopeConfiguration_SearchScopeResultObjectType">SearchScopeResultObjectType</a></td><td>
Resource Type - System name of the type of resource that the search scope returns.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SearchScopeConfiguration_SearchScopeTargetURL">SearchScopeTargetURL</a></td><td>
Redirecting URL - Relative path for the page where search results are to be show for searches from the home page.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SearchScopeConfiguration_UsageKeyword">UsageKeyword</a></td><td>
