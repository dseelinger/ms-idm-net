...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.ConstantSpecifier<br />
...
**VB**<br />
``` VB
Public Class ConstantSpecifier
	Inherits IdmResource
```

**C++**<br />
``` C++
public ref class ConstantSpecifier : public IdmResource
```

**F#**<br />
``` F#
type ConstantSpecifier =  
    class
        inherit IdmResource
    end
```

The ConstantSpecifier type exposes the following members.
...
<a href="#constantspecifier-class">Back to Top</a>
...
List of attributes for which we have data for this particular object. Note that due to performance reasons, there may be other attributes and values in the identity manager service, but they may not have been retrieved yet.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ConstantSpecifier_BoundAttributeType">BoundAttributeType</a></td><td>
Attribute Type - The binding's attribute type</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ConstantSpecifier_BoundObjectType">BoundObjectType</a></td><td>
Resource Type - The binding's resource type</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ConstantSpecifier_ConstantValueKey">ConstantValueKey</a></td><td>
Constant Value Key - It is a the constant key value.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_IdmResource_CreatedTime">CreatedTime</a></td><td>
...
(aka Resource ID) The value of the attribute is a globally unique identifier (GUID) assigned by FIM to each resource when it is created. Note that it is not required here since this class also represents resources that may not have been created as well as existing resources.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ConstantSpecifier_ObjectType">ObjectType</a></td><td>
