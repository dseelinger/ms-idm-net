# ActivityInformationConfiguration Class
...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.ActivityInformationConfiguration<br />
...
**VB**<br />
``` VB
Public Class ActivityInformationConfiguration
	Inherits IdmResource
```

**C++**<br />
``` C++
public ref class ActivityInformationConfiguration : public IdmResource
```

**F#**<br />
``` F#
type ActivityInformationConfiguration =  
    class
        inherit IdmResource
    end
```

The ActivityInformationConfiguration type exposes the following members.
...
<a href="#activityinformationconfiguration-class">Back to Top</a>

## Properties
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ActivityInformationConfiguration_ActivityName">ActivityName</a></td><td>
Activity Name - The class name of the correspondent activity</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ActivityInformationConfiguration_AssemblyName">AssemblyName</a></td><td>
Assembly Name - The assembly where the activity settings part is defined</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_IdmResource_Attributes">Attributes</a></td><td>
...
(aka Expiration Time) The date and time when the resource expires. The appropriate Management Policy Rule will delete the resource when the current date and time is later than the date and time specified in this attribute.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ActivityInformationConfiguration_IsActionActivity">IsActionActivity</a></td><td>
Is Action Activity - This is an indication that this activity could be put into an action process</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ActivityInformationConfiguration_IsAuthenticationActivity">IsAuthenticationActivity</a></td><td>
Is Authentication Activity - This is an indication that this activity could be put into an authentication process</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ActivityInformationConfiguration_IsAuthorizationActivity">IsAuthorizationActivity</a></td><td>
Is Authorization Activity - This is an indication that this activity could be put into an authorization process</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ActivityInformationConfiguration_IsConfigurationType">IsConfigurationType</a></td><td>
...
(aka Resource ID) The value of the attribute is a globally unique identifier (GUID) assigned by FIM to each resource when it is created. Note that it is not required here since this class also represents resources that may not have been created as well as existing resources.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ActivityInformationConfiguration_ObjectType">ObjectType</a></td><td>
...
(aka Resource Time) The date and time of a representation of a resource. This attribute is updated by the FIM service. This attribute can be used to define time triggered Management Policy Rules.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ActivityInformationConfiguration_TypeName">TypeName</a></td><td>
Type Name - The class name of the activity settings part.</td></tr></table>&nbsp;
<a href="#activityinformationconfiguration-class">Back to Top</a>
