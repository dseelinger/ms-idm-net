# SupportedLocaleConfiguration Class
...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.SupportedLocaleConfiguration<br />
...
**VB**<br />
``` VB
Public Class SupportedLocaleConfiguration
	Inherits IdmResource
```

**C++**<br />
``` C++
public ref class SupportedLocaleConfiguration : public IdmResource
```

**F#**<br />
``` F#
type SupportedLocaleConfiguration =  
    class
        inherit IdmResource
    end
```

The SupportedLocaleConfiguration type exposes the following members.
...
<a href="#supportedlocaleconfiguration-class">Back to Top</a>
...
(aka Expiration Time) The date and time when the resource expires. The appropriate Management Policy Rule will delete the resource when the current date and time is later than the date and time specified in this attribute.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SupportedLocaleConfiguration_IsConfigurationType">IsConfigurationType</a></td><td>
...
(aka Resource ID) The value of the attribute is a globally unique identifier (GUID) assigned by FIM to each resource when it is created. Note that it is not required here since this class also represents resources that may not have been created as well as existing resources.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SupportedLocaleConfiguration_ObjectType">ObjectType</a></td><td>
...
(aka Resource Time) The date and time of a representation of a resource. This attribute is updated by the FIM service. This attribute can be used to define time triggered Management Policy Rules.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_SupportedLocaleConfiguration_SupportedLanguageCode">SupportedLanguageCode</a></td><td>
Supported Language Code - This attribute lists language codes for all supported locales in FIM Portal.</td></tr></table>&nbsp;
<a href="#supportedlocaleconfiguration-class">Back to Top</a>
