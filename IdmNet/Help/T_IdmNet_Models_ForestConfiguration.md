...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.ForestConfiguration<br />
...
**C++**<br />
``` C++
public ref class ForestConfiguration : public IdmResource
```

**F#**<br />
``` F#
type ForestConfiguration =  
    class
        inherit IdmResource
    end
```

The ForestConfiguration type exposes the following members.
...
<a href="#forestconfiguration-class">Back to Top</a>
