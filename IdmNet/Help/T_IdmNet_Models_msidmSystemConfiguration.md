# msidmSystemConfiguration Class
...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.msidmSystemConfiguration<br />
...
**VB**<br />
``` VB
Public Class msidmSystemConfiguration
	Inherits IdmResource
```

**C++**<br />
``` C++
public ref class msidmSystemConfiguration : public IdmResource
```

**F#**<br />
``` F#
type msidmSystemConfiguration =  
    class
        inherit IdmResource
    end
```

The msidmSystemConfiguration type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_IdmNet_Models_msidmSystemConfiguration__ctor">msidmSystemConfiguration()</a></td><td>
Parameterless CTOR</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_IdmNet_Models_msidmSystemConfiguration__ctor_1">msidmSystemConfiguration(IdmResource)</a></td><td>
Build a msidmSystemConfiguration object from a IdmResource object</td></tr></table>&nbsp;
<a href="#msidmsystemconfiguration-class">Back to Top</a>
...
(aka Expiration Time) The date and time when the resource expires. The appropriate Management Policy Rule will delete the resource when the current date and time is later than the date and time specified in this attribute.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmSystemConfiguration_IsConfigurationType">IsConfigurationType</a></td><td>
Is Configuration Type - This value specified whether or not the resource is a configuration resource.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_IdmResource_Item">Item</a></td><td>
...
The region and language for which the representation of a resource has been adapted.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmSystemConfiguration_msidmCreateCriteriaBasedGroupsAsDeferredByDefault">msidmCreateCriteriaBasedGroupsAsDeferredByDefault</a></td><td>
Create Criteria-based Groups as Deferred By Default - If this setting is set to true then any criteria-based group that will be created in the system while it is true will be marked for deferred evaluation.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmSystemConfiguration_msidmReportingLoggingEnabled">msidmReportingLoggingEnabled</a></td><td>
Reporting Logging Enabled - This is a global setting that controls whether service activity is logged for reporting purposes.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmSystemConfiguration_msidmRequestMaximumActiveDuration">msidmRequestMaximumActiveDuration</a></td><td>
Request Maximum Active Duration - Requests that exceed this duration before reaching a final state will be automatically canceled by the system. Value defined in days.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmSystemConfiguration_msidmRequestMaximumCancelingDuration">msidmRequestMaximumCancelingDuration</a></td><td>
Request Maximum Canceling Duration - Maximum duration a request can be in the Canceling state before the system auto terminates it. Value defined in days.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmSystemConfiguration_msidmSystemThrottleLevel">msidmSystemThrottleLevel</a></td><td>
System Throttle Level - Increasing this number will allocate more system resources to process outstanding workloads. Setting the value to -1 will disable the system resource throttling.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_IdmResource_MVObjectID">MVObjectID</a></td><td>
...
(aka Resource ID) The value of the attribute is a globally unique identifier (GUID) assigned by FIM to each resource when it is created. Note that it is not required here since this class also represents resources that may not have been created as well as existing resources.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmSystemConfiguration_ObjectType">ObjectType</a></td><td>
