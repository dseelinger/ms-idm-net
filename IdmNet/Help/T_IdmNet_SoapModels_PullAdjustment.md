...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;IdmNet.SoapModels.PullAdjustment<br />
...
**C++**<br />
``` C++
public ref class PullAdjustment
```

**F#**<br />
``` F#
type PullAdjustment =  class end
```

The PullAdjustment type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_IdmNet_SoapModels_PullAdjustment__ctor">PullAdjustment</a></td><td>
CTOR - enumerate forwards by default</td></tr></table>&nbsp;
<a href="#pulladjustment-class">Back to Top</a>
