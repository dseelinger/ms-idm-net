# msidmRequestTargetDetail Class
...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.msidmRequestTargetDetail<br />
...
**VB**<br />
``` VB
Public Class msidmRequestTargetDetail
	Inherits IdmResource
```

**C++**<br />
``` C++
public ref class msidmRequestTargetDetail : public IdmResource
```

**F#**<br />
``` F#
type msidmRequestTargetDetail =  
    class
        inherit IdmResource
    end
```

The msidmRequestTargetDetail type exposes the following members.
...
<a href="#msidmrequesttargetdetail-class">Back to Top</a>
