...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.msidmReportingJob<br />
...
**VB**<br />
``` VB
Public Class msidmReportingJob
	Inherits IdmResource
```

**C++**<br />
``` C++
public ref class msidmReportingJob : public IdmResource
```

**F#**<br />
``` F#
type msidmReportingJob =  
    class
        inherit IdmResource
    end
```

The msidmReportingJob type exposes the following members.
...
<a href="#msidmreportingjob-class">Back to Top</a>
...
The region and language for which the representation of a resource has been adapted.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmReportingJob_msidmCompletedTime">msidmCompletedTime</a></td><td>
Completed Time - The time at which an action has reached its final status.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmReportingJob_msidmReportingJobDetails">msidmReportingJobDetails</a></td><td>
Reporting Job Details - This attribute defines the operational information associated with a reporting job.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmReportingJob_msidmReportingJobStatus">msidmReportingJobStatus</a></td><td>
Reporting Job Status - This attribute defines the status of a reporting job.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmReportingJob_msidmReportingJobType">msidmReportingJobType</a></td><td>
Reporting Job Type - This attribute defines the type of reporting job being represented by a reporting job object.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmReportingJob_msidmStartTime">msidmStartTime</a></td><td>
Start Time - This attribute defines the start time and date of a reporting job object and is specified in UTC.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_IdmResource_MVObjectID">MVObjectID</a></td><td>
...
(aka Resource ID) The value of the attribute is a globally unique identifier (GUID) assigned by FIM to each resource when it is created. Note that it is not required here since this class also represents resources that may not have been created as well as existing resources.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_msidmReportingJob_ObjectType">ObjectType</a></td><td>
