...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.mv_data<br />
...
**VB**<br />
``` VB
Public Class mv_data
	Inherits IdmResource
```

**C++**<br />
``` C++
public ref class mv_data : public IdmResource
```
...
The mv_data type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_IdmNet_Models_mv_data__ctor">mv_data()</a></td><td>
Parameterless CTOR</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_IdmNet_Models_mv_data__ctor_1">mv_data(IdmResource)</a></td><td>
Build a mv_data object from a IdmResource object</td></tr></table>&nbsp;
<a href="#mv_data-class">Back to Top</a>
