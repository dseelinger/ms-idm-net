...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;IdmNet.SoapModels.PullInfo<br />
...
**C++**<br />
``` C++
public ref class PullInfo
```

**F#**<br />
``` F#
type PullInfo =  class end
```

The PullInfo type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_IdmNet_SoapModels_PullInfo__ctor">PullInfo</a></td><td>
Initializes a new instance of the PullInfo class</td></tr></table>&nbsp;
<a href="#pullinfo-class">Back to Top</a>
