...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.PortalUIConfiguration<br />
...
**VB**<br />
``` VB
Public Class PortalUIConfiguration
	Inherits IdmResource
```

**C++**<br />
``` C++
public ref class PortalUIConfiguration : public IdmResource
```

**F#**<br />
``` F#
type PortalUIConfiguration =  
    class
        inherit IdmResource
    end
```

The PortalUIConfiguration type exposes the following members.
...
<a href="#portaluiconfiguration-class">Back to Top</a>
...
List of attributes for which we have data for this particular object. Note that due to performance reasons, there may be other attributes and values in the identity manager service, but they may not have been retrieved yet.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_PortalUIConfiguration_BrandingCenterText">BrandingCenterText</a></td><td>
Branding Center Text - The centered branding text that used by branding control</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_PortalUIConfiguration_BrandingLeftImage">BrandingLeftImage</a></td><td>
Branding Left Image - The left url image that is used by branding control</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_PortalUIConfiguration_BrandingRightImage">BrandingRightImage</a></td><td>
Branding Right Image - The right url image that used by branding control</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_IdmResource_CreatedTime">CreatedTime</a></td><td>
...
(aka Expiration Time) The date and time when the resource expires. The appropriate Management Policy Rule will delete the resource when the current date and time is later than the date and time specified in this attribute.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_PortalUIConfiguration_IsConfigurationType">IsConfigurationType</a></td><td>
...
Resource Indexer - get's the attribute of the resource object as indexed by name.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_PortalUIConfiguration_ListViewCacheTimeOut">ListViewCacheTimeOut</a></td><td>
ListView Cache Time Out - Specify the amount of time for the ListView cache to time out and expire.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_PortalUIConfiguration_ListViewPageSize">ListViewPageSize</a></td><td>
ListView Items per Page - Specify the number of items to show per page in all ListViews.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_PortalUIConfiguration_ListViewPagesToCache">ListViewPagesToCache</a></td><td>
ListView Pages to Cache - Specify the number of pages to cache while retrieving ListView results.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_IdmResource_Locale">Locale</a></td><td>
...
(aka Resource ID) The value of the attribute is a globally unique identifier (GUID) assigned by FIM to each resource when it is created. Note that it is not required here since this class also represents resources that may not have been created as well as existing resources.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_PortalUIConfiguration_ObjectType">ObjectType</a></td><td>
...
(aka Resource Time) The date and time of a representation of a resource. This attribute is updated by the FIM service. This attribute can be used to define time triggered Management Policy Rules.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_PortalUIConfiguration_TimeZone">TimeZone</a></td><td>
Time Zone - Reference to timezone configuration</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_PortalUIConfiguration_UICacheTime">UICacheTime</a></td><td>
Global Cache Duration - This time how long the UI configuration element will be kept on the cache</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_PortalUIConfiguration_UICountCacheTime">UICountCacheTime</a></td><td>
Navigation Bar Resource Count Cache Duration - This time how long the UI dynamic counts will stay on the cache before it expired</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_PortalUIConfiguration_UIUserCacheTime">UIUserCacheTime</a></td><td>
Per User Cache Duration - This time for how long the UI user data will stay on the cache before it expired</td></tr></table>&nbsp;
<a href="#portaluiconfiguration-class">Back to Top</a>
