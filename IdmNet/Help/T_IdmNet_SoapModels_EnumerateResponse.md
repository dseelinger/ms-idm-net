...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;IdmNet.SoapModels.EnumerateResponse<br />
...
**C++**<br />
``` C++
public ref class EnumerateResponse
```

**F#**<br />
``` F#
type EnumerateResponse =  class end
```

The EnumerateResponse type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_IdmNet_SoapModels_EnumerateResponse__ctor">EnumerateResponse</a></td><td>
Initializes a new instance of the EnumerateResponse class</td></tr></table>&nbsp;
<a href="#enumerateresponse-class">Back to Top</a>
