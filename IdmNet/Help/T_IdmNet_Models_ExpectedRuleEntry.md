...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="T_IdmNet_Models_IdmResource">IdmNet.Models.IdmResource</a><br />&nbsp;&nbsp;&nbsp;&nbsp;IdmNet.Models.ExpectedRuleEntry<br />
...
**VB**<br />
``` VB
Public Class ExpectedRuleEntry
	Inherits IdmResource
```

**C++**<br />
``` C++
public ref class ExpectedRuleEntry : public IdmResource
```

**F#**<br />
``` F#
type ExpectedRuleEntry =  
    class
        inherit IdmResource
    end
```

The ExpectedRuleEntry type exposes the following members.
...
<a href="#expectedruleentry-class">Back to Top</a>
...
(aka Display Name) Display name for the resource.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ExpectedRuleEntry_ExpectedRuleEntryAction">ExpectedRuleEntryAction</a></td><td>
Expected Rule Entry Action - Indicates whether to apply or stop applying a sync rule.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_IdmResource_ExpectedRulesList">ExpectedRulesList</a></td><td>
...
(aka Resource ID) The value of the attribute is a globally unique identifier (GUID) assigned by FIM to each resource when it is created. Note that it is not required here since this class also represents resources that may not have been created as well as existing resources.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ExpectedRuleEntry_ObjectType">ObjectType</a></td><td>
Object Type (can only be ExpectedRuleEntry)
 (Overrides <a href="P_IdmNet_Models_IdmResource_ObjectType">IdmResource.ObjectType</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ExpectedRuleEntry_ResourceParent">ResourceParent</a></td><td>
Resource Parent - This is a reference to the container resource.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_IdmResource_ResourceTime">ResourceTime</a></td><td>
(aka Resource Time) The date and time of a representation of a resource. This attribute is updated by the FIM service. This attribute can be used to define time triggered Management Policy Rules.
 (Inherited from <a href="T_IdmNet_Models_IdmResource">IdmResource</a>.)</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ExpectedRuleEntry_StatusError">StatusError</a></td><td>
Status Error - Sync rule error details upon failure.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ExpectedRuleEntry_SynchronizationRuleData">SynchronizationRuleData</a></td><td>
Synchronization Rule Data - Xml describing the values of workflow parameters.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ExpectedRuleEntry_SynchronizationRuleID">SynchronizationRuleID</a></td><td>
Synchronization Rule ID - This is a reference to a SynchronizationRule resource.</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ExpectedRuleEntry_SynchronizationRuleName">SynchronizationRuleName</a></td><td>
Synchronization Rule Name - This is the name of a SynchronizationRule</td></tr><tr><td>![Public property](media/pubproperty.gif "Public property")</td><td><a href="P_IdmNet_Models_ExpectedRuleEntry_SynchronizationRuleStatus">SynchronizationRuleStatus</a></td><td>
Synchronization Rule Status - Indicates Applied, Not Applied, or Pending.</td></tr></table>&nbsp;
<a href="#expectedruleentry-class">Back to Top</a>
