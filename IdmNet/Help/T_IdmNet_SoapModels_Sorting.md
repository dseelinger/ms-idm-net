...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;IdmNet.SoapModels.Sorting<br />
...
**C++**<br />
``` C++
public ref class Sorting
```

**F#**<br />
``` F#
type Sorting =  class end
```
...
## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_IdmNet_SoapModels_Sorting__ctor">Sorting</a></td><td>
Default CTOR sorts by DisplayName, Ascending</td></tr></table>&nbsp;
<a href="#sorting-class">Back to Top</a>
