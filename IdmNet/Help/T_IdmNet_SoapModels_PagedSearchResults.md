...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;IdmNet.SoapModels.PagedSearchResults<br />
...
**C++**<br />
``` C++
public ref class PagedSearchResults
```

**F#**<br />
``` F#
type PagedSearchResults =  class end
```

The PagedSearchResults type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="M_IdmNet_SoapModels_PagedSearchResults__ctor">PagedSearchResults</a></td><td>
Parameterless CTOR</td></tr></table>&nbsp;
<a href="#pagedsearchresults-class">Back to Top</a>
